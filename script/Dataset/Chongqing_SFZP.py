...
def read_xlsx(file_path):
    data = pd.read_excel(file_path, sheet_name = '收费站基础信息数据')
    return data
...
def adjust_data(file_path):
    ...
    data.rename(columns={'站点ID': 'ID'}, inplace=True)
    data.rename(columns={'站点HEX编号': 'HEX'}, inplace=True)
...
if __name__ == "__main__":
    ...
    save_path = 'E:/expressway project/Data/.chongqing/Graph/place/SFZP.shp'
