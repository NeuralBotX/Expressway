...
# build_road_networkx = AboutNetwork( file_path = [path_road + 'Road_G.shp' , path_point + 'SFZP.shp', path_point + 'GANTRY.shp'], Host_file_path = Host_file_path, Expressway = True)
...
G_Point,G_Road,G_Simplify,G_Plus = build_road_networkx(combined_network = True, draw = True, save=False)